...
export default class YourModule extends React.Component {
  ...
  async pollInterval() {
    ...
    if (this.state && this.state.YourContract) {
      //let yourVar = await this.state.YourContract.YourVar("balanceOf").call();
        ...
        <div className="form-group w-100">
          <div style={{ width: "100%", textAlign: "center" }}>
            ...
            <button
              ...
              onClick={async () => {
                let hashSigned = this.props.web3.utils.sha3(
                  "jabronie pie" + Math.random()
                );
                let sig;
                //sign the hash using either the meta account OR the etherless account
                if (this.props.privateKey) {
                  sig = this.props.web3.eth.accounts.sign(
                    hashSigned,
                ...
                this.props.tx(
                  this.state.YourContract.sign(hashSigned, sig),
                  50000,
                  0,
                  0,
                  result => {
          ...
          <button
            ...
            onClick={this.deployYourContract.bind(this)}
          >
            <Scaler config={{ startZoomAt: 400, origin: "50% 50%" }}>
          ...
          <div className="content bridge row">
            ...
            <div className="col-4 p-1">
              <div style={{ padding: 20, textAlign: "center" }}>
                ...
                <div style={{ padding: 5 }}>
                  it has{" "}
                  {this.props.dollarDisplay(this.state.yourContractBalance)}
                </div>
                <div style={{ padding: 5 }}>
                  with <b>yourVar:</b>
                  <div>"{this.state.yourVar}"</div>
                </div>
              </div>
            </div>
            <div className="col-4 p-1">
              <button
                ...
                onClick={() => {
                  ...
                  this.props.tx(
                    this.state.YourContract.withdraw(amount),
                    40000,
                    0,
                    0,
                    result => {
